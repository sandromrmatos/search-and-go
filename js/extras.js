...
function renderInfo(tab = 'basics') {
  ...
  if (tab === 'basics') {
    out.push(
      ...
      el('h4', { text: 'The map' }),
      el('p', { html: `Real places around you become points on the map: <b>shops</b>, <b>cafes and other amenities</b>, <b>tourist spots</b>, <b>bus stops</b>, <b>industrial and service buildings</b>, <b>leisure spots</b> like pitches, playgrounds and sports centres, and even <b>street furniture</b> — <b>trees</b>, <b>poles</b> and <b>pedestrian crossings</b>. Everything within <b>${RULES.SCAN_RADIUS_M} m</b> is checked, and the whole map re-rolls every <b>${RULES.SCAN_INTERVAL_MS / 60000} minutes</b>. <b>Green space</b> is the exception — <b>parks</b>, <b>gardens</b> and <b>grass</b> produce battle grunts instead of loot.` }),
      el('p', { html: `Out on a quiet street the smaller sources matter: a lamp post or a crossing is a point like any other. They cannot crowd each other out, because nothing appears within <b>${RULES.MIN_SPAWN_SEPARATION_M} m</b> of another point, so a row of twenty trees still only produces what fits.` }),
